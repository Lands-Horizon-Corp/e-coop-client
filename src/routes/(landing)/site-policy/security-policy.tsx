...
// Ensure this component uses React.forwardRef

export const Route = createFileRoute('/(landing)/site-policy/security-policy')({
    component: RouteComponent,
})

// Helper function to format section IDs for display in the TOC
const formatSectionTitle = (id: string): string => {
    // Specific formatting adjustments for clarity in TOC
            ...
            >
                ...
                >
                    <div>
                        ...
                        <br />
                        Chief Information Security Officer / CEO, Lands Horizon
                        Corp
                        <br />
                        Email: <LinkTag
