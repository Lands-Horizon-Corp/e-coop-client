...
export const Route = createFileRoute('/(landing)/site-policy/risk-management-policy')({
...
function RouteComponent() {
    ...
    // Effect to scroll to section if hash is present in URL on initial load
    useEffect(() => {
    ...
    return (
        <PageContainer className="w-full flex flex-row flex-grow">
            <div
                ...
                className="flex-1 overflow-y-auto px-4 py-8 border-r border-gray-200 dark:border-gray-700 h-[calc(100vh-theme(spacing.16))]"
            >
                ...
                <p className="mb-6">
                    ...
                    sustainability of the cooperative bank and its
                    stakeholders.
                ...
                >
                    <div>
                        ...
                        <ul className="list-disc pl-10 space-y-2">
                            ...
                            <li>
                                <strong>Compliance and Legal Risk:</strong> Risks
                                of non-compliance with laws, regulations, and
                                contractual obligations.
                            </li>
                            <li>
                                <strong>Information Security and Cyber Risk:</strong>{' '}
                ...
                >
                    <div>
                        ...
                        <br />
                        Email: <LinkTag
                            href="lands.horizon.corp@gmail.com"
                    ...
                    {articleList.map((sectionId, idx) => (
                        <li key={sectionId}>
                            <a
                                ...
                                className="block py-1 text-green-600 dark:text-green-400 hover:underline cursor-pointer text-sm"
                            >
                                {idx + 1}
                                {'. '}
