...
import MemberClassificationTable from '@/components/tables/footsteps-table/member/member-classification-table'
...
import MemberClassificationTableOwnerAction from '@/components/tables/footsteps-table/member/member-classification-table/row-actions/member-classification-table-owner-action'
