...
export enum ComputationTypeEnum {
    ...
    'Diminishing Add-On' = 'Diminishing Add-On',
    'Diminishing Yearly' = 'Diminishing Yearly',
    'Diminishing Straight' = 'Diminishing Straight',
    'Diminishing Quarterly' = 'Diminishing Quarterly',
}
