...
export const RebateReportSchema = z
    .object({
...
export type TRebateReportSchema = z.infer<typeof RebateReportSchema>

export interface IRebateReportFormProps
    extends
        IClassProps,
        IForm<
            Partial<TRebateReportSchema>,
            IGeneratedReport,
            Error,
            TRebateReportSchema
        > {}
...
const RebateCreateReportForm = ({
    ...
    const form = useForm<TRebateReportSchema>({
        resolver: standardSchemaResolver(RebateReportSchema),
        mode: 'onSubmit',
        defaultValues: async () =>
            buildFormDefaults<TRebateReportSchema>({
    ...
    const { formRef, handleFocusError, isDisabled } =
        useFormHelper<TRebateReportSchema>({
            form,
            ...formProps,
        })
...
export const RebateCreateReportFormModal = ({
    ...
    formProps?: Omit<IRebateReportFormProps, 'className' | 'onClose'>
}) => {
