...
export const CloseAccountReportSchema = z
    .object({
...
export type TCloseAccountReportSchema = z.infer<typeof CloseAccountReportSchema>

export interface ICloseAccountReportFormProps
    extends
        IClassProps,
        IForm<
            Partial<TCloseAccountReportSchema>,
            IGeneratedReport,
            Error,
...
const CloseAccountReportCreateForm = ({
    ...
    const form = useForm<TCloseAccountReportSchema>({
        resolver: standardSchemaResolver(CloseAccountReportSchema),
        ...
        defaultValues: {
            ...
            report_config: {
                ...
                module: 'Account',
                name: `close_account_report_${toReadableDate(new Date(), 'MMddyy_mmss')}.pdf`,
            },
        },
    })
    ...
    const { formRef, handleFocusError, isDisabled } =
        useFormHelper<TCloseAccountReportSchema>({
            form,
            ...formProps,
        })
...
export const CloseAccountReportCreateFormModal = ({
    ...
    formProps?: Omit<ICloseAccountReportFormProps, 'className' | 'onClose'>
}) => {
