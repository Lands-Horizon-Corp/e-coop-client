    ...
    return (
        <section className=" min-h-screen overflow-hidden">
            ...
            <FlickeringGrid
                ...
                maxOpacity={0.5}
                flickerChance={0.05}
                className="absolute inset-0 h-screen w-full -top-1/4 -z-10 opacity-50 [mask-image:linear-gradient(to_bottom,white_0%,white_0%,transparent_100%)] dark:opacity-80"
            />
