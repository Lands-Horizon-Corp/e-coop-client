...
import {
    ...
    useGetPaginatedInventoryHazard,
} from '../inventory-hazard.service'
import { IInventoryHazard } from '../inventory-hazard.types'
import InventoryHazardTableColumns, {
    IInventoryHazardTableColumnProps,
    inventoryHazardGlobalSearchTargets,
} from './columns'
import {
    InventoryHazardAction,
    InventoryHazardRowContext,
    InventoryHazardTableActionManager,
} from './row-action-context'

export interface InventoryHazardTableProps
    extends TableProps<IInventoryHazard>, IInventoryHazardTableColumnProps {
    toolbarProps?: Omit<
        IDataTableToolbarProps<IInventoryHazard>,
        | 'table'
        | 'refreshActionProps'
        | 'globalSearchProps'
        | 'scrollableProps'
...
const InventoryHazardTable = ({
    persistKey = ['inventory-hazard'],
    className,
    toolbarProps,
    defaultFilter,
    onSelectData,
    ...
    actionComponent = InventoryHazardAction,
    RowContextComponent = InventoryHazardRowContext,
}: InventoryHazardTableProps) => {
    ...
    const tableState = useDataTableState<IInventoryHazard>({
        key: finalKeys,
                ...
                >
                    <DataTableToolbar
                        deleteActionProps={{
                            onDeleteSuccess: () =>
                                queryClient.invalidateQueries({
                                    queryKey: ['inventory-hazard', 'paginated'],
                                }),
                        ...
                        globalSearchProps={{
                            ...
                            targets: inventoryHazardGlobalSearchTargets,
                        }}
                        refreshActionProps={{
                            onClick: () => refetch(),
...
export default InventoryHazardTable
