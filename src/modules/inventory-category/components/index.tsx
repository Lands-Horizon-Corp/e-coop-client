...
import InventoryCategoryTableColumns, {
    IInventoryCategoryTableColumnProps,
    inventoryCategoryGlobalSearchTargets,
} from './columns'
import {
    InventoryCategoryAction,
    InventoryCategoryRowContext,
    InventoryCategoryTableActionManager,
} from './row-action-context'

export interface InventoryCategoryTableProps
    extends TableProps<IInventoryCategory>, IInventoryCategoryTableColumnProps {
    toolbarProps?: Omit<
        IDataTableToolbarProps<IInventoryCategory>,
        | 'table'
        | 'refreshActionProps'
        | 'globalSearchProps'
        | 'scrollableProps'
...
const InventoryCategoryTable = ({
    ...
    actionComponent = InventoryCategoryAction,
    RowContextComponent = InventoryCategoryRowContext,
    ...
    const tableState = useDataTableState<IInventoryCategory>({
        key: finalKeys,
                ...
                >
                    <DataTableToolbar
                        ...
                        globalSearchProps={{
                            ...
                            targets: inventoryCategoryGlobalSearchTargets,
                        }}
                        refreshActionProps={{
                            onClick: () => refetch(),
