...
export const QuickTransferTransactionForm = ({
    ...
    useEffect(() => {
        ...
        if (form.formState.isDirty) {
            disableScope('member-picker')
        }
        form.setFocus('amount')
    }, [selectedAccount, form, selectedMember, disableScope])

    return (
        <HotkeysProvider initiallyActiveScopes={['quick-transfer-form']}>
            <Form {...form}>
                <form
                        ...
                        <FormFieldWrapper
                            ...
                            render={({ field }) => (
                                <MemberPicker
                                    ...
                                    value={
                                        form.getValues('member') ?? undefined
                                    }
