### NAMING STANDARD FOR TEMPLATES

`<templateprefix>-<version>-<variant>.njk`

- version - can be number
- variant - normal | large | compact
- templateprefix - anything na gusto mo

example:

`ofv-1-normal.njk`

- ofv - means Other Fund Voucher
- 1 - version 1 of template
- normal - variant sizing of font size, padding, margin

### THE VARIANTS

#### normal

- Good for normal paper size (ex: 8.5in x 11in)
- normal font size, padding, and margins

#### compact

- Good for printing small apper sizes (ex: 125mm x 176mm)
- printing with small paper sizes
- bring compact padding, font size, and margins

#### large

- Good for printing normal apper sizes (ex: letter / a5)
- bring larger padding, font size, and margins

### THE STANDARD SHARED CSS
...
<style>
    ...
    * {
    ...
    .sig-line {
        ...
        /* make line relative to font size */
        font-weight: 600;
        font-size: var(--fs-base);
        color: #1f2937;
...
#### THEN PWEDE NA MAGAMIT NA GANTO SA BODY

```html
<body class="variant-normal">
    <!-- OR -->
    <body class="variant-compact"></body>
</body>
```
...
<div class="info-grid grid-2">
    <div class="info-item">
        <p>
            ...
            ><span class="info-value">{{ pay_to }}</span>
        </p>
        <p>
    ...
    <div class="info-item">
        <p>
            ...
            ><span class="info-value">{{ voucher_no }}</span>
        </p>
        <p>
            <span class="info-label">Release Date:</span
            ><span class="info-value">{{ date_release }}</span>
        </p>
    </div>
</div>
```
...
```html
<div class="amount-words">*** {{ total_amount_in_words }} ONLY ***</div>
```
...
<div class="check-details">
    <div>
        <span class="info-label">Check No:</span>
        <span class="info-value">{{ check_number }}</span>
    </div>

    <div>
        <span class="info-label payment-label-offset">Check Date:</span>
        <span class="info-value">{{ check_date }}</span>
    </div>
</div>
```
...
```html
<div class="reprint-indicator">*** REPRINTED ({{ print_count }}) ***</div>
```
