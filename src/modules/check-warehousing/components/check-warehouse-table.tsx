...
} from '@/modules/check-warehousing'
import {
    getCoreRowModel,
    getSortedRowModel,
    useReactTable,
...
import CheckWarehousingTableColumns, {
    ICheckWarehousingTableColumnProps,
    checkWarehousingGlobalSearchTargets,
} from './check-warehouse-columns'
import CheckWarehousingAction, {
    CheckWarehousingRowContext,
    CheckWarehousingTableActionManager,
} from './check-warehousing-action-context'

export interface CheckWarehousingTableProps
    extends TableProps<ICheckWarehousing>, ICheckWarehousingTableColumnProps {
    toolbarProps?: Omit<
        IDataTableToolbarProps<ICheckWarehousing>,
        | 'table'
        | 'refreshActionProps'
        | 'globalSearchProps'
        | 'scrollableProps'
...
const CheckWarehousingTable = ({
    persistKey = ['check-warehousing'],
    className,
    toolbarProps,
    defaultFilter,
    onSelectData,
    ...
    actionComponent = CheckWarehousingAction,
    RowContextComponent = CheckWarehousingRowContext,
}: CheckWarehousingTableProps) => {
    ...
    const tableState = useDataTableState<ICheckWarehousing>({
        key: finalKeys,
                ...
                >
                    <DataTableToolbar
                        ...
                        globalSearchProps={{
                            ...
                            targets: checkWarehousingGlobalSearchTargets,
                        }}
                        refreshActionProps={{
                            onClick: () => refetch(),
...
export default CheckWarehousingTable
