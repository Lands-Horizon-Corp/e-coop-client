...
const TransactionViewNoMemberSelected = ({
    ...
    return (
        <div className="relative flex h-64 min-w-64 flex-col items-center justify-center gap-y-2 rounded-xl bg-background before:absolute before:left-1/2 before:top-[40%] before:z-0 before:size-44 before:-translate-x-1/2 before:-translate-y-1/2 before:rounded-full before:bg-secondary/20 before:content-[''] after:absolute after:left-1/2 after:top-[40%] after:z-0 after:h-32 after:w-64 after:-translate-x-1/2 after:-translate-y-1/2 after:rounded-xl after:bg-secondary/60 after:content-['']">
