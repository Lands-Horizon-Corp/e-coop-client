                                    ...
                                    <FormFieldWrapper
                                        ...
                                        render={({ field }) => (
                                            <RadioGroup
                                                value={field.value ?? ''}
                                                onValueChange={field.onChange}
                                                className="flex items-center gap-x-4 py-4 rounded-xl border-2 px-4 "
                                            >
                                                <FormItem>
                                                    <div className="flex items-start gap-x-2">
                                                        ...
                                                        <div className="flex items-start gap-3">
                                                            ...
                                                            >
                                                                <span className="text-muted-foreground text-xs leading-[inherit] font-normal mr-1">
                                                                    <PinLocationIcon
                                                                        aria-hidden="true"
                                                                        className="shrink-0 inline size-4 opacity-60"
                                                                    />
                                                                </span>
                                                                Field Collection
                                                            </label>
                                        ...
                                        <FormFieldWrapper
                                            ...
                                            render={({ field }) => (
                                                <RadioGroup
                                                    ...
                                                    className="space-x-2 py-4 flex rounded-xl border-2 px-4"
                                                >
                                                    <FormItem>
                                                            ...
                                                            <div className="flex items-center gap-2 min-w-0">
                                                                <div className="min-w-0">
                                                                    <label
                                                                        ...
                                                                        className="text-foreground text-sm font-medium cursor-pointer block"
                                                                    >
                                                                        None
                                                                    </label>
                                                                </div>
