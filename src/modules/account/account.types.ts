...
export const IAccountRequestSchema = z.object({
  ...
  fines_amort: z.number().min(0, "Fines amort must be non-negative").optional(),
  fines_maturity: z
    .number()
  ...
  coh_cib_fines_grace_period_entry_daily_amortization: z
    ...
    .min(0)
    .optional(),
  coh_cib_fines_grace_period_entry_daily_maturity: z.number().min(0).optional(),
  ...
  lumpsum_computation_type: z.nativeEnum(LumpsumComputationTypeEnum).optional(),
  ...
  interest_fines_computation_diminishing_straight_diminishing_yearly: z
    ...
    .optional(),
  earned_unearned_interest: z.nativeEnum(EarnedUnearnedInterestEnum).optional(),
