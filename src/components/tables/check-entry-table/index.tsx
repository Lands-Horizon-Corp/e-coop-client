...
import {
    ...
    exportAll,
    exportSelected,
} from '@/api-service/check-entry-service'
...
import { useFilteredPaginatedCheckEntry } from '@/hooks/api-hooks/use-check-entry'
...
const CheckEntryTable = ({
    ...
    const {
        ...
        refetch,
    } = useFilteredPaginatedCheckEntry({
        pagination,
        sort: sortingState,
                    ...
                    deleteActionProps={{
                        onDeleteSuccess: () =>
                            queryClient.invalidateQueries({
                                queryKey: ['check-entry', 'resource-query'],
                            }),
...
export default CheckEntryTable
