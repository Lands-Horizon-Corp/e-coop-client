...
import { deleteMany } from '@/api-service/permission-template-service'
...
import { useFilteredPaginatedPermissionTemplate } from '@/hooks/api-hooks/use-permission-template'
import { useDataTableSorting } from '@/hooks/data-table-hooks/use-datatable-sorting'
import useDataTableState from '@/hooks/data-table-hooks/use-datatable-state'
import useDatableFilterState from '@/hooks/use-filter-state'
import { usePagination } from '@/hooks/use-pagination'

import { IPermissionTemplate, TableProps } from '@/types'
...
const PermissionTemplateTable = ({
    ...
    const {
        ...
        refetch,
    } = useFilteredPaginatedPermissionTemplate({
        pagination,
        sort: sortingState,
