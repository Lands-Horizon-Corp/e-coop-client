...
export interface BatchDepositEntryTableProps
    extends TableProps<IDepositEntry>,
        IDepositEntryTableColumnProps {
    toolbarProps?: Omit<
        IDataTableToolbarProps<IDepositEntry>,
        | 'table'
        | 'refreshActionProps'
        | 'globalSearchProps'
        | 'scrollableProps'
        ...
        <FilterContext.Provider value={filterState}>
            ...
            >
                <DataTableToolbar
                    globalSearchProps={{
                        defaultMode: 'equal',
                        targets: depositEntryGlobalSearchTargets,
                    }}
                    table={table}
                    refreshActionProps={{
                        onClick: () => refetch(),
...
export default BatchDepositEntryTable
