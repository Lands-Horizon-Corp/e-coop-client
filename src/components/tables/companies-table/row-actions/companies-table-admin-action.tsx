    ...
    return (
        <RowActionsGroup
            ...
            onEdit={{
                ...
                onClick: () => {
                    router.navigate({
                        to: '/admin/companies-management/$companyId/edit' as string,
            ...
            onView={{
                ...
                onClick: () => {
                    router.navigate({
                        to: '/admin/companies-management/$companyId/view' as string,
                        params: { companyId: company.id },
                    })
                },
            }}
            otherActions={
                <>
                    ...
                    <DropdownMenuItem
                        onClick={() => {
                            router.navigate({
                                to: '/admin/companies-management/$companyId/branch' as string,
                                params: { companyId: company.id },
                            })
                        }}
                    >
