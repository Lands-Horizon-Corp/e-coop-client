...
import { deleteMany } from '@/api-service/collateral-service'
...
import { useFilteredPaginatedCollateral } from '@/hooks/api-hooks/use-collateral'
...
const CollateralTable = ({
    ...
    const {
        ...
        refetch,
    } = useFilteredPaginatedCollateral({
        pagination,
        sort: sortingState,
