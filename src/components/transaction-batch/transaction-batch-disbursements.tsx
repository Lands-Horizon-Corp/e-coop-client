...
import { CreditCardIcon, PlusIcon, RenderIcon } from '@/components/icons'
import { Button } from '@/components/ui/button'

import { useFilteredPaginatedDisbursementTransaction } from '@/hooks/api-hooks/use-disbursement-transaction'
import { useModalState } from '@/hooks/use-modal-state'
import { useSubscribe } from '@/hooks/use-pubsub'

import { IDisbursementTransaction, TEntityId, TIcon } from '@/types'
...
const TransactionBatchDisbursementTransaction = ({
    ...
    const {
        ...
        onSuccess: onDisbursementUpdate,
    })
